...
```powershell
.\packaging\build.ps1 -Version 1.0.3
```

O executavel de teste sera criado em `dist\SIPPER\SIPPER.exe` e o instalador final em `dist-installer\SIPPER-Setup-1.0.3.exe`.
